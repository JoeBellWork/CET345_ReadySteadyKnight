...
public class HandelAnimation : MonoBehaviour
{
    ...
    // fixed update function that controls input and when animations are triggered
    ...
    // handel attack animations and combos
    void HandleAttacks()
    {
        if (states.canAttack)
        {
    ...
    // turn off used animation for reseting
