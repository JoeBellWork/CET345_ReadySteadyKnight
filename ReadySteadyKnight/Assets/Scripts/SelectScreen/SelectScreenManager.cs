...
public class SelectScreenManager : MonoBehaviour
{
    ...
    public PortraitData[] potraitPrefabs; // entires as portraits
    public int maxX; // hardcoded X and Y limits for portraits
    public int maxY;
    PortraitData[,] charGrid; // grid for selection entires
    ...
    void Start()
    {
        ...
        //create grid
        charGrid = new PortraitData[maxX, maxY];
        int x = 0;
        int y = 0;

        potraitPrefabs = potraitCanvas.GetComponentsInChildren<PortraitData>();
...
{
    public PortraitData activePotrait; // current active portrait for P1
    public PortraitData previewPotrait;
